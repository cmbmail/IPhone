...
const ReportCenter = () => {
  ...
  return (
    <div>
      ...
      <Tabs defaultActiveKey="phone-asset">
        <TabPane tab="电话资产报表" key="phone-asset">
          <Row gutter={16} style={{ marginBottom: 16 }}>
            <Col span={6}>
              <Card>
                <Statistic 
                  title="电话总数" 
                  value={phoneAssetReport.totalPhones || 0} 
                />
              </Card>
            </Col>
            <Col span={6}>
        ...
        <TabPane tab="账单分摊报表" key="allocation">
          <Row gutter={16} style={{ marginBottom: 16 }}>
            <Col span={6}>
              <Card>
                <Statistic 
            ...
            <Col span={6}>
              <Card>
                <Statistic 
                  title="已分摊组织" 
                  value={allocationReport.allocatedOrgs || 0} 
                />
              </Card>
            </Col>
          </Row>
        ...
        <TabPane tab="工单报表" key="work-order">
          <Card style={{ marginBottom: 16 }}>
            <Select 
              value={startDate} 
          ...
          <Row gutter={16} style={{ marginBottom: 16 }}>
            <Col span={6}>
              <Card>
                <Statistic 
                  title="工单总数" 
                  value={workOrderReport.totalOrders || 0} 
                />
              </Card>
            </Col>
            <Col span={6}>
